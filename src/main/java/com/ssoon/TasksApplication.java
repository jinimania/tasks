...
public class TasksApplication {
  ...
  @Bean
  CommandLineRunner runner(final TaskService taskService) {
    return args -> {
      ...
      taskService.save(new Task(4L, "Create services and repository classes", LocalDate.now().plus(5, ChronoUnit.DAYS), false));
